...
--
-- Name: orders add_insert_to_ord1; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE add_insert_to_ord1 AS
...
--
-- Name: orders add_insert_to_ord2; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE add_insert_to_ord2 AS
    ON INSERT TO public.orders
